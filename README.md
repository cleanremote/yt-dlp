...
* `player_js_variant`: The player javascript variant to use for n/sig deciphering. The known variants are: `main`, `tcc`, `tce`, `es5`, `es6`, `es6_tcc`, `es6_tce`, `tv`, `tv_es6`, `phone`, `plasma_es6`, `plasma_es6_tcc`, `plasma_es6_tce`, `embed`, `embed_tcc`, `embed_tce`, `embed_es6`, `embed_es6_tcc`, `embed_es6_tce`, `house`. The default is `main`, and the others are for debugging purposes. You can use `actual` to go with what is prescribed by the site
